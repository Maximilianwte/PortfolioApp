            ...
            <template v-for="(Image, index) in Images">
                <div v-bind:key="index"
                    ...
                    <div class="delete-button absolute mt-2 ml-4">
                        <svg @click="delete_file(Image.Id)" class="grand-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <div class="params flex w-full justify-between pt-2">
                        <div class="id w-1/4">
                            ...
                            <input class="button w-1/3 text-bg_primary py-2 px-4 border rounded" id="id" type="number" v-bind:value="Image.Id" max="9999">
                        </div>
                        <div class="title w-1/4">
                            <label class="button text-main_primary text-2xl pr-4" for="">Title:</label>
                            <input class="button w-full text-bg_primary py-2 px-4 border rounded" id="title" type="text" v-bind:value="Image.Titel" maxlength="24">
                        </div>
                        <div class="place w-1/4">
                            <label class="button text-main_primary text-2xl pr-4" for="">Place:</label>
                            <input class="button w-full text-bg_primary py-2 px-4 border rounded" id="place" type="text" v-bind:value="Image.Aufnahmeort" maxlength="42">
                        </div>
